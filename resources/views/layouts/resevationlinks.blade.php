...
<script src="{{asset('assets/js/all.min.js')}}"></script>
<script src="{{asset('assets/js/modules/reservation/reservationpage.js')}}"></script>
<script src="{{asset('assets/js/modules/reservation/reservationvalidation.js')}}"></script>

<!-- // lawyer validate -->
<script src="{{asset('assets/js/modules/lawyer-register/lawyer.js')}}"></script>
<script src="{{asset('assets/js/modules/lawyer-register/lawyervalidation.js')}}"></script>
<!-- // user validate -->
<script src="{{asset('assets/js/modules/user-register/user.js')}}"></script>
<script src="{{asset('assets/js/modules/user-register/uservalidation.js')}}"></script>
